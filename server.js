...
function onChatHandler(target, context, msg, self) {
  ...
  if (commandName === '!social') {
    client.say(target, `socials at S-K1#2908 and https://discord.gg/3SV7EXYp3v`);
  }

  if (commandName === 'what game is it?') {
    client.say('target', Xayedgames is playing league of legends');
  }
  ...
  if (commandName === 'Who made you?') {
    client.say(target, `S-K1#2908, The Happer himself`);
  }
